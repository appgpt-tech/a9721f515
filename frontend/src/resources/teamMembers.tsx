...
const teamMembersTitle = () => {
  ...
  return <span>teamMembers {record ? `"${ record.name }"` : ""}</span>;
};

export const teamMembersList = () => (
      <List actions={<ListActions  />} filters={ResourceFilters} >
        <DatagridConfigurable>
          <NumberField source="memberID" />
<TextField source="name" />
<EmailField source="email" />
<TextField source="role" />
<DateField source="joinDate" /><EditButton />
                    ...
                    <Edit title={<teamMembersTitle />}>
                      <SimpleForm>
                        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
                          <Grid item xs={4}>
<NumberInput source="memberID"   /></Grid>
<Grid item xs={4}>
...
<Grid item xs={4}>
<DateInput source="joinDate"   /></Grid>
                        </Grid>
                      </SimpleForm>
                    </Edit>
                  );
